...
- Original path: `.claude/skills/performance-smell-detection/`
...
- Placed in `skills/shared/` because the skill uses standard YAML frontmatter and natural-language workflows with no agent-specific commands.
